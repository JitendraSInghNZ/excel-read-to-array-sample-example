 ...
 * only 1 output result, than how to use the setOutputSingletResult() method to store the 
...
public class TestIndeed {
	...
	public static void main(String[] args) throws FileNotFoundException, Exception {
				...
				String[] resultArray = new String[excelReadStringArrayXSL.getRowLenght()];
				...
				excelReadStringArrayXSL.setOutputSingletResult(testDataArray, resultArray, outputFilePath);		
